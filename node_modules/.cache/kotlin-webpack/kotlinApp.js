(function (_, Kotlin, $module$kotlinx_coroutines_core, $module$kotlin_react, $module$kotlin_react_dom, $module$kotlinx_html_js, $module$kotlin_css_js, $module$kotlin_styled, $module$react_player, $module$react_share) {
  'use strict';
  ...
  var set_color = $module$kotlin_css_js.kotlinx.css.set_color_ommczd$;
  var get_pt = $module$kotlin_css_js.kotlinx.css.get_pt_rcaex3$;
  var set_fontSize = $module$kotlin_css_js.kotlinx.css.set_fontSize_n8chyh$;
  var set_fontFamily = $module$kotlin_css_js.kotlinx.css.set_fontFamily_krvuuu$;
  var set_padding = $module$kotlin_css_js.kotlinx.css.set_padding_krvuuu$;
  var set_marginBottom = $module$kotlin_css_js.kotlinx.css.set_marginBottom_n8chyh$;
  var set_border = $module$kotlin_css_js.kotlinx.css.set_border_krvuuu$;
  var get_px = $module$kotlin_css_js.kotlinx.css.get_px_rcaex3$;
  var set_marginTop = $module$kotlin_css_js.kotlinx.css.set_marginTop_n8chyh$;
  ...
  function App$render$lambda$lambda$lambda$lambda(this$App, this$) {
    return function (it) {
  ...
  function App$render$lambda$lambda$lambda(closure$currentVideo, this$App) {
    return function ($receiver) {
      ...
      $receiver.onWatchedButtonPressed = App$render$lambda$lambda$lambda$lambda(this$App, $receiver);
      return Unit;
    };
  }
  ...
  function App$render$lambda$lambda$lambda$lambda_1(closure$video) {
    return function ($receiver) {
      $receiver.currentVideo = closure$video;
      return Unit;
    };
  ...
  function App$render$lambda$lambda$lambda_1(this$App) {
    return function (video) {
      setState(this$App, App$render$lambda$lambda$lambda$lambda_1(video));
      return Unit;
    };
  }
  function App$render$lambda$lambda_0(this$App) {
    return function ($receiver) {
      ...
      $receiver.selectedVideo = this$App.state.currentVideo;
      $receiver.onSelectVideo = App$render$lambda$lambda$lambda_1(this$App);
      return Unit;
    };
  }
  App.prototype.render_ss14n$ = function ($receiver) {
    ...
    if ((tmp$ = this.state.currentVideo) != null) {
      videoPlayer($receiver_0_0, App$render$lambda$lambda$lambda(tmp$, this));
    }
    ...
    $receiver_0_2.unaryPlus_pdl1vz$('Videos to watch');
    $receiver_0_1.child_2usv9w$($receiver_0_2.create());
    videoList($receiver_0_1, App$render$lambda$lambda(this));
    ...
    videoList($receiver_0_1, App$render$lambda$lambda_0(this));
  ...
  function VideoPlayerProps() {
  }
  VideoPlayerProps.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'VideoPlayerProps',
    interfaces: []
  };
  ...
  function VideoPlayer$render$lambda$lambda$lambda_0(this$VideoPlayer) {
    return function ($receiver) {
      $receiver.attrs.url = this$VideoPlayer.props.video.videoUrl;
      $receiver.invoke_eb8iu4$($module$react_share.FacebookIcon, VideoPlayer$render$lambda$lambda$lambda$lambda_1);
      return Unit;
    };
  }
  ...
  function VideoPlayer$render$lambda$lambda$lambda_1(this$VideoPlayer) {
    return function ($receiver) {
      $receiver.attrs.url = this$VideoPlayer.props.video.videoUrl;
      $receiver.invoke_eb8iu4$($module$react_share.TelegramIcon, VideoPlayer$render$lambda$lambda$lambda$lambda_2);
      return Unit;
    };
  }
  VideoPlayer.prototype.render_ss14n$ = function ($receiver) {
    ...
    set_backgroundColor($receiver_1, this.props.unwatchedVideo ? Color.Companion.lightGreen : Color.Companion.red);
    set_color($receiver_1, this.props.unwatchedVideo ? Color.Companion.black : Color.Companion.white);
    set_fontSize($receiver_1, get_pt(12));
    set_fontFamily($receiver_1, 'Arial');
    set_padding($receiver_1, '10pt');
    set_marginBottom($receiver_1, get_pt(10));
    ...
    $receiver_0_2.invoke_eb8iu4$($module$react_share.FacebookShareButton, VideoPlayer$render$lambda$lambda$lambda_0(this));
  ...
  _.VideoPlayerProps = VideoPlayerProps;
  ...
  return _;
}(module.exports, require('kotlin'), require('kotlinx-coroutines-core'), require('kotlin-react'), require('kotlin-react-dom'), require('kotlinx-html-js'), require('kotlin-css-js'), require('kotlin-styled'), require('react-player'), require('react-share')));
